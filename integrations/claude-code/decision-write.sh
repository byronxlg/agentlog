...
# Increment session decision counter
...
printf '%d' "$new_count" > "$count_file"

verbose "decision written (session total: $new_count)"
verbose "Session summary: $new_count decisions captured"
